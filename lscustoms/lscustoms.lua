...
local lsc = {
	...
	,["primarymetallic"] = { 
			...
			buttons = { 
				...
				{name = "Noir carbonne",costs = 0, colorindex = 147, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Hraphite",costs = 0, colorindex = 1, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Noir Anhracite",costs = 0, colorindex = 11, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Noir Steel",costs = 0, colorindex = 2, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Sombre Steel",costs = 0, colorindex = 3, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Argenté",costs = 0, colorindex = 4, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Argenté Bluish",costs = 0, colorindex = 5, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Roll Steel",costs = 0, colorindex = 6, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Ombre argentée",costs = 0, colorindex = 7, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Argent pierre",costs = 0, colorindex = 8, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Argent minuit",costs = 0, colorindex = 9, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Argent Cast Iron",costs = 0, colorindex = 10, description = "", centre = 0, font = 0, scale = 0.4},
				...
				{name = "Rouge Lava",costs = 0, colorindex = 150, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Rouge Blaze",costs = 0, colorindex = 30, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Rouge Grace",costs = 0, colorindex = 31, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Rouge Garnet",costs = 0, colorindex = 32, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Rouge Sunset",costs = 0, colorindex = 33, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Rouge Cabernet",costs = 0, colorindex = 34, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Rouge Wine",costs = 0, colorindex = 143, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Rouge Candy",costs = 0, colorindex = 35, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Rose chaud",costs = 0, colorindex = 135, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Rose Pfsiter",costs = 0, colorindex = 137, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Rose saumon",costs = 0, colorindex = 136, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Orange Sunrise",costs = 0, colorindex = 36, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Orange",costs = 0, colorindex = 38, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Orange Bright",costs = 0, colorindex = 138, description = "", centre = 0, font = 0, scale = 0.4},
				...
				{name = "Jaune Race",costs = 0, colorindex = 89, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Jaune Dew",costs = 0, colorindex = 91, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Vert Dark",costs = 0, colorindex = 49, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Vert Racing",costs = 0, colorindex = 50, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Vert Sea",costs = 0, colorindex = 51, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Vert Olive",costs = 0, colorindex = 52, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Vert Bright",costs = 0, colorindex = 53, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Vert Gasoline",costs = 0, colorindex = 54, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Vert Lime",costs = 0, colorindex = 92, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Bleu Midnight",costs = 0, colorindex = 141, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Bleu Galaxy",costs = 0, colorindex = 61, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Bleu Dark",costs = 0, colorindex = 62, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Bleu Saxon",costs = 0, colorindex = 63, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Bleu",costs = 0, colorindex = 64, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Bleu Mariner",costs = 0, colorindex = 65, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Bleu Harbor",costs = 0, colorindex = 66, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Bleu Diamond",costs = 0, colorindex = 67, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Bleu Surf",costs = 0, colorindex = 68, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Bleu Nautical" ,costs = 0, colorindex = 69, description = "", centre = 0, font = 0, scale = 0.4},
				...
				{name = "Bleu Light",costs = 0, colorindex = 74, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Marron Chocolate",costs = 0, colorindex = 96, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Marron Bison",costs = 0, colorindex = 101, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Marron Creeen",costs = 0, colorindex = 95, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Marron Feltzer",costs = 0, colorindex = 94, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Marron Maple",costs = 0, colorindex = 97, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Marron Beechwood",costs = 0, colorindex = 103, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Marron Sienna",costs = 0, colorindex = 104, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Marron Saddle",costs = 0, colorindex = 98, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Marron Moss",costs = 0, colorindex = 100, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Marron Woodbeech",costs = 0, colorindex = 102, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Marron Straw",costs = 0, colorindex = 99, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Marron Sandy",costs = 0, colorindex = 105, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Marron Bleached",costs = 0, colorindex = 106, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Violet Schafter",costs = 0, colorindex = 71, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Violet Spinnaker",costs = 0, colorindex = 72, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Violet Midnight",costs = 0, colorindex = 142, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Violet Bright",costs = 0, colorindex = 145, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Crème",costs = 0, colorindex = 107, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Blanc glacial",costs = 0, colorindex = 111, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Blanc frost",costs = 0, colorindex = 112, description = "", centre = 0, font = 0, scale = 0.4}
			}
		},
		["secondarymetallic"] = { 
		...
		["primarymatte"] = { 
				...
				buttons = { 
					...
					{name = "Gris", colorindex = 13,costs = 0, description = "", centre = 0, font = 0, scale = 0.4},
					{name = "Gris lumière", colorindex = 14,costs = 0, description = "", centre = 0, font = 0, scale = 0.4},
					{name = "Blanc glacial", colorindex = 131,costs = 0, description = "", centre = 0, font = 0, scale = 0.4},
					{name = "Bleu", colorindex = 83,costs = 0, description = "", centre = 0, font = 0, scale = 0.4},
					{name = "Bleu Dark", colorindex = 82,costs = 0, description = "", centre = 0, font = 0, scale = 0.4},
					{name = "Bleu Midnight", colorindex = 84,costs = 0, description = "", centre = 0, font = 0, scale = 0.4},
					{name = "Violet Midnight", colorindex = 149,costs = 0, description = "", centre = 0, font = 0, scale = 0.4},
					{name = "Violet Schafter", colorindex = 148,costs = 0, description = "", centre = 0, font = 0, scale = 0.4},
					{name = "Rouge", colorindex = 39,costs = 0, description = "", centre = 0, font = 0, scale = 0.4},
					{name = "Rouge sombre", colorindex = 40,costs = 0, description = "", centre = 0, font = 0, scale = 0.4},
					...
					{name = "Citron vert", colorindex = 55,costs = 0, description = "", centre = 0, font = 0, scale = 0.4},
					{name = "Vert", colorindex = 128,costs = 0, description = "", centre = 0, font = 0, scale = 0.4},
					{name = "Vert Frost", colorindex = 151,costs = 0, description = "", centre = 0, font = 0, scale = 0.4},
					{name = "Vert Foliage", colorindex = 155,costs = 0, description = "", centre = 0, font = 0, scale = 0.4},
		...
		["windows"] = { 
			...
			name = "windows",
			buttons = { 
				{name = "Aucun",tint = false, costs = 0, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Noir pur",tint = 1, costs = 0, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Fumée noire",tint = 2, costs = 0, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Fumée grise",tint = 3, costs = 0, description = "", centre = 0, font = 0, scale = 0.4},
		...
		["wheelaccessories"] = { 
			title = "accessoires roues", 
			name = "wheelaccessories",
			buttons = { 
				{name = "Pneus standards", costs = 0, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Pneus customisés", costs = 0, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Pneus anti-balles", costs = 0, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Pneus fumée blanche", color = {254,254,254}, costs = 0, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Pneus fumée noire", color = {1,1,1}, costs = 0, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Pneus fumée bleue", color = {0,150,255}, costs = 0, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Pneus fumée jaune", color = {255,255,50}, costs = 0, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Pneus fumée orange", color = {255,153,51}, costs = 0, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Pneus fumée rouge", color = {255,10,10}, costs = 0, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Pneus fumée verte", color = {10,255,10}, costs = 0, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Pneus fumée violette", color = {153,10,153}, costs = 0, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Pneus fumée rose", color = {255,102,178}, costs = 0, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Pneus fumée grise", color = {128,128,128}, costs = 0, description = "", centre = 0, font = 0, scale = 0.4},
			}
		},
		["respray"] = { 
			title = "Peintures", 
		...
		["primarycolor"] = { 
			...
			buttons = { 
				...
				{name = "Métalique", description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Métal", description = "", centre = 0, font = 0, scale = 0.4}
			}
		}
		,
		["secondarycolor"] = { 
		...
		["secondaryclassic"] = { 
			...
			name = "suspensions",
			buttons = { 
				{name = "Suspension standard",mod = -1,modtype =15, costs = 0, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Supension agréable",mod = false,modtype =15, costs = 0, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Suspension de rue",mod = 1,modtype =15, costs = 0, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Suspension sportive",mod = 2,modtype =15, costs = 0, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Suspension pour circuits",mod = 3,modtype =15, costs = 0, description = "", centre = 0, font = 0, scale = 0.4}
			}
		},
		["transmission"] = { 
			title = "transmissions", 
			name = "transmission",
			buttons = { 
				{name = "Transmission standard",mod = -1,modtype =13, costs = 0, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Transmission de rue",mod = false,modtype =13, costs = 0, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Transmission sportive",mod = 1,modtype =13, costs = 0, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Transmission pour circuits",mod = 2,modtype =13, costs = 0, description = "", centre = 0, font = 0, scale = 0.4}
			}
		}
		,
		["turbo"] = { 
		...
		["wheels"] = { 
			...
			name = "wheels",
			buttons = { 
				{name = "Type de jantes", description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Couleur des jantes", description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Accessoires pour roues", description = "", centre = 0, font = 0, scale = 0.4}
			}
		},
		["wheeltype"] = { 
		...
		["backwheel"] = { 
			...
			buttons = { 
				...
				{name = "Kits Néons", description = "", centre = 0, font = 0, scale = 0.4}
			}
		},
		["neonkits"] = { 
			title = "kits neons", 
			name = "neonkits",
			buttons = { 
				{name = "Format néons", description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Couleurs néons", description = "", centre = 0, font = 0, scale = 0.4}
			}
		},
		["neonlayout"] = { 
			title = "formats neons", 
			...
			buttons = { 
				...
				{name = "Devant,Arrière et côtés",costs =0, description = "", centre = 0, font = 0, scale = 0.4}
			}
		},
		["neoncolor"] = { 
			title = "couleurs neons", 
			name = "neoncolor",
			buttons = { 
				{name = "Blanc", color = {255,255,255}, costs = 0, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Bleu", color = {0,0,255}, costs = 0, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Bleu éléctrique", color = {0,150,255}, costs = 0, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Menthe verte", color = {50,255,155}, costs = 0, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Citron vert", color = {0,255,0}, costs = 0, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Jaune", color = {255,255,0}, costs = 0, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Doré", color = {204,204,0}, costs = 0, description = "", centre = 0, font = 0, scale = 0.4},
				...
				{name = "Rose poney", color = {255,102,255}, costs = 0, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Rose chaud", color = {255,0,255}, costs = 0, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Violet", color = {153,0,153}, costs = 0, description = "", centre = 0, font = 0, scale = 0.4},
			}
		},
		["headlights"] = { 
			title = "phares", 
			name = "headlights",
			buttons = { 
				{name = "Phares standards",mod = false, modtype = 22,costs = 0, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Phares Xénons",mod = true,modtype = 22,costs = 0, description = "", centre = 0, font = 0, scale = 0.4}
			}
		},
		["plate"] = { 
			title = "plaques", 
		...
		name = "repair",
		buttons = { 
			{name = "Réparer le véhicule", description = "Full body repair and engine service.", costs = 0, centre = 0, font = 0, scale = 0.4}
	...
	["armor"] = { 
		...
		name = "armor",
		buttons = { 
			{name = "Je ne crains pas les balles",modtype = 16, mod = -1,costs = 0, description = "", centre = 0, font = 0, scale = 0.4},
			{name = "Blindage augmenté de 20%",modtype = 16, mod = false, costs = 0, description = "", centre = 0, font = 0, scale = 0.4},
			{name = "Blindage augmenté de 40%",modtype = 16, mod = 1, costs = 0, description = "", centre = 0, font = 0, scale = 0.4},
			{name = "Blindage augmenté de 60%",modtype = 16, mod = 2, costs = 0, description = "", centre = 0, font = 0, scale = 0.4},
			{name = "Blindage augmenté de 80%",modtype = 16, mod = 3, costs = 0, description = "", centre = 0, font = 0, scale = 0.4},
			{name = "Blindage augmenté de 100%",modtype = 16, mod = 4, costs = 0, description = "", centre = 0, font = 0, scale = 0.4}
	...
	["brakes"] = { 
		...
		name = "brakes",
		buttons = { 
			{name = "Freins basiques",modtype = 12, mod = -1, costs = 0, description = "", centre = 0, font = 0, scale = 0.4},
			{name = "Freins de rue",modtype = 12, mod = false, costs = 0, description = "", centre = 0, font = 0, scale = 0.4},
			{name = "Freins sportifs",modtype = 12, mod = 1, costs = 0, description = "", centre = 0, font = 0, scale = 0.4},
			{name = "Freins pour circuits",modtype = 12, mod = 2, costs = 0, description = "", centre = 0, font = 0, scale = 0.4}
			
		}
	},
	["engine"] = { 
		title = "parametres moteur", 
		name = "engine",
		buttons = { 
			{name = "Mise à niveau, Level 1",modtype = 11, mod = -1, costs = 0, description = "", centre = 0, font = 0, scale = 0.4},
			{name = "Mise à niveau, Level 2",modtype = 11, mod = false, costs = 0, description = "", centre = 0, font = 0, scale = 0.4},
			{name = "Mise à niveau, Level 3",modtype = 11, mod = 1, costs = 0, description = "", centre = 0, font = 0, scale = 0.4},
			{name = "Mise à niveau, Level 4",modtype = 11, mod = 2, costs = 0, description = "", centre = 0, font = 0, scale = 0.4}
		}
	},
	["horn"] = { 
			title = "klaxons", 
			name = "horn",
			buttons = { 
				{name = "Klaxon de base",modtype = 14, mod = -1,costs =0, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Klaxon de camion",modtype = 14, mod = false,costs =0, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Klaxon policier",modtype = 14, mod = 1,costs =0, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Klaxon de clown",modtype = 14, mod = 2,costs =0, description = "", centre = 0, font = 0, scale = 0.4},
				...
				{name = "Klaxon blague nulle",modtype = 14, mod = 8,costs =0, description = "", centre = 0, font = 0, scale = 0.4},
				...
				{name = "Klaxon classique 9",modtype = 14, mod = 35,costs =0, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Klaxon Do",modtype = 14, mod = 16,costs =0, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Klaxon Re",modtype = 14, mod = 17,costs =0, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Klaxon Mi",modtype = 14, mod = 18,costs =0, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Klaxon Fa",modtype = 14, mod = 19,costs =0, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Klaxon Sol",modtype = 14, mod = 20,costs =0, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Klaxon La",modtype = 14, mod = 21,costs =0, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Klaxon Ti",modtype = 14, mod = 22,costs =0, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Klaxon Do",modtype = 14, mod = 23,costs =0, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Klaxon Jazz 1",modtype = 14, mod = 25,costs =0, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Klaxon Jazz 2",modtype = 14, mod = 26,costs =0, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Klaxon Jazz 3",modtype = 14, mod = 27,costs =0, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Klaxon Jazz 4",modtype = 14, mod = 28,costs =0, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Klaxon Starspangban 1",modtype = 14, mod = 29,costs =0, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Klaxon Starspangban 2",modtype = 14, mod = 30,costs =0, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Klaxon Starspangban 3",modtype = 14, mod = 31,costs =0, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Klaxon Starspangban 4",modtype = 14, mod = 32,costs =0, description = "", centre = 0, font = 0, scale = 0.4},
		...
		if DoesEntityExist(veh) then
			...
			for i = 0,16 do
				if GetNumVehicleMods(veh,i) ~= nil and GetNumVehicleMods(veh,i) ~= false then
						...
						elseif i == 1 then
							bumper = true
							insrt(lsc.menu["bumpers"].buttons, {name = "Pare-chocs avants", description = "", centre = 0, font = 0, scale = 0.4})
						elseif i == 2 then
							bumper = true
							insrt(lsc.menu["bumpers"].buttons, {name = "Pare-chocs arrières", description = "", centre = 0, font = 0, scale = 0.4})
						elseif i == 3 then
							insrt(lsc.menu["main"].buttons, {name = "Jupes", description = "", centre = 0, font = 0, scale = 0.4})
						elseif i == 4 then
							insrt(lsc.menu["main"].buttons, {name = "Echappement", description = "", centre = 0, font = 0, scale = 0.4})
						elseif i == 5 then
							insrt(lsc.menu["main"].buttons, {name = "Intérieur", description = "", centre = 0, font = 0, scale = 0.4})
						elseif i == 6 then
			...
			insrt(lsc.menu["main"].buttons, {name = "Lumières", description = "", centre = 0, font = 0, scale = 0.4})
			insrt(lsc.menu["main"].buttons, {name = "Plaque", description = "", centre = 0, font = 0, scale = 0.4})
			insrt(lsc.menu["main"].buttons, {name = "Peinture", description = "Respray your vehicle", centre = 0, font = 0, scale = 0.4})
			...
			if GetNumVehicleMods(veh,mod) ~= nil and GetNumVehicleMods(veh,mod) ~= false then
				insrt(lsc.menu["frontbumper"].buttons , {name = "Aucun",modtype = mod,costs = 0,mod = -1, description = "", centre = 0, font = 0, scale = 0.4})
			...
			Citizen.Trace(tostring(veh).." mod:"..mod.." num:"..tostring(GetNumVehicleMods(veh,mod)))
			if GetNumVehicleMods(veh,mod) ~= nil and GetNumVehicleMods(veh,mod) ~= false then
				insrt(lsc.menu["rearbumper"].buttons, {name = "Aucun",modtype = mod,costs = 0,mod = -1, description = "", centre = 0, font = 0, scale = 0.4})
				for i = 0,  tonumber(GetNumVehicleMods(veh,mod)) -1 do
					local lbl = GetModTextLabel(veh,mod,i)
					Citizen.Trace(tostring(lbl))
					Citizen.Trace(GetLabelText(lbl))
			...
			Citizen.Trace(tostring(veh).." mod:"..mod.." num:"..tostring(GetNumVehicleMods(veh,mod)))
			if GetNumVehicleMods(veh,mod) ~= nil and GetNumVehicleMods(veh,mod) ~= false then
				insrt(lsc.menu["exhaust"].buttons, {name = "Aucun",modtype = mod,costs = 0,mod = -1, description = "", centre = 0, font = 0, scale = 0.4})
				for i = 0,   tonumber(GetNumVehicleMods(veh,mod)) -1 do
					local lbl = GetModTextLabel(veh,mod,i)
					Citizen.Trace(tostring(lbl))
					Citizen.Trace(GetLabelText(lbl))
			...
			Citizen.Trace(tostring(veh).." mod:"..mod.." num:"..tostring(GetNumVehicleMods(veh,mod)))
			if GetNumVehicleMods(veh,mod) ~= nil and GetNumVehicleMods(veh,mod) ~= false then
				insrt(lsc.menu["fenders"].buttons, {name = "Aucune",modtype = mod,costs = 0,mod = -1, description = "", centre = 0, font = 0, scale = 0.4})
				for i = 0,   tonumber(GetNumVehicleMods(veh,mod)) -1 do
					local lbl = GetModTextLabel(veh,mod,i)
					Citizen.Trace(tostring(lbl))
					Citizen.Trace(GetLabelText(lbl))
			...
			Citizen.Trace(tostring(veh).." mod:"..mod.." num:"..tostring(GetNumVehicleMods(veh,mod)))
			if GetNumVehicleMods(veh,mod) ~= nil and GetNumVehicleMods(veh,mod) ~= false then
				insrt(lsc.menu["hood"].buttons, {name = "Aucun",modtype = mod,costs = 0,mod = -1, description = "", centre = 0, font = 0, scale = 0.4})
				for i = 0,    tonumber(GetNumVehicleMods(veh,mod)) -1 do
					local lbl = GetModTextLabel(veh,mod,i)
					Citizen.Trace(tostring(lbl))
					Citizen.Trace(GetLabelText(lbl))
			...
			Citizen.Trace(tostring(veh).." mod:"..mod.." num:"..tostring(GetNumVehicleMods(veh,mod)))
			if GetNumVehicleMods(veh,mod) ~= nil and GetNumVehicleMods(veh,mod) ~= false then
				insrt(lsc.menu["rollcage"].buttons, {name = "Aucun",modtype = mod,costs = 0,mod = -1, description = "", centre = 0, font = 0, scale = 0.4})
				for i = 0,    tonumber(GetNumVehicleMods(veh,mod)) -1 do
					local lbl = GetModTextLabel(veh,mod,i)
					Citizen.Trace(tostring(lbl))
					Citizen.Trace(GetLabelText(lbl))
			...
			Citizen.Trace(tostring(veh).." mod:"..mod.." num:"..tostring(GetNumVehicleMods(veh,mod)))
			if GetNumVehicleMods(veh,mod) ~= nil and GetNumVehicleMods(veh,mod) ~= false then
				insrt(lsc.menu["roof"].buttons, {name = "Aucun",modtype = mod,costs = 0,mod = -1, description = "", centre = 0, font = 0, scale = 0.4})
				for i = 0,    tonumber(GetNumVehicleMods(veh,mod)) -1 do
					local lbl = GetModTextLabel(veh,mod,i)
					Citizen.Trace(tostring(lbl))
					Citizen.Trace(GetLabelText(lbl))
			...
			Citizen.Trace(tostring(veh).." mod:"..mod.." num:"..tostring(GetNumVehicleMods(veh,mod)))
			if GetNumVehicleMods(veh,mod) ~= nil and GetNumVehicleMods(veh,mod) ~= false then
				insrt(lsc.menu["skirts"].buttons, {name = "Aucun",modtype = mod,costs = 0,mod = -1, description = "", centre = 0, font = 0, scale = 0.4})
				for i = 0,   tonumber(GetNumVehicleMods(veh,mod)) -1 do
					local lbl = GetModTextLabel(veh,mod,i)
					Citizen.Trace(tostring(lbl))
					Citizen.Trace(GetLabelText(lbl))
			...
			Citizen.Trace(tostring(veh).." mod:"..mod.." num:"..tostring(GetNumVehicleMods(veh,mod)))
			if GetNumVehicleMods(veh,mod) ~= nil and GetNumVehicleMods(veh,mod) ~= false then
				insrt(lsc.menu["spoiler"].buttons, {name = "Aucun",modtype = mod,costs = 0,mod = -1, description = "", centre = 0, font = 0, scale = 0.4})
				for i = 0,   tonumber(GetNumVehicleMods(veh,mod)) -1 do
					local lbl = GetModTextLabel(veh,mod,i)
					Citizen.Trace(tostring(lbl))
					Citizen.Trace(GetLabelText(lbl))
			...
			Citizen.Trace(tostring(veh).." mod:"..mod.." num:"..tostring(GetNumVehicleMods(veh,mod)))
			if GetNumVehicleMods(veh,mod) ~= nil and GetNumVehicleMods(veh,mod) ~= false then
				insrt(lsc.menu["grille"].buttons, {name = "Aucune",modtype = mod,costs = 0,mod = -1, description = "", centre = 0, font = 0, scale = 0.4})
				for i = 0,  tonumber(GetNumVehicleMods(veh,mod)) -1 do
					local lbl = GetModTextLabel(veh,mod,i)
					Citizen.Trace(tostring(lbl))
					Citizen.Trace(GetLabelText(lbl))
			...
			Citizen.Trace(tostring(veh).." mod:"..mod.." num:"..tostring(GetNumVehicleMods(veh,mod)))
			if GetNumVehicleMods(veh,mod) ~= nil and GetNumVehicleMods(veh,mod) ~= false then
				insrt(lsc.menu["chassis"].buttons, {name = "Aucun",modtype = mod,costs = 0,mod = -1, description = "", centre = 0, font = 0, scale = 0.4})
				for i = 0,  tonumber(GetNumVehicleMods(veh,mod)) -1 do
					local lbl = GetModTextLabel(veh,mod,i)
					Citizen.Trace(tostring(lbl))
					Citizen.Trace(GetLabelText(lbl))
					...
					for i,pos in ipairs(lsc.locations) do
						...
						if GetDistanceBetweenCoords(outside.x,outside.y,outside.z,GetEntityCoords(ped)) <= f(5) then
							if pos.locked == false then
								drawTxt("Appuyez sur ~b~ENTRER~w~ pour rentrer chez ~b~Los Santos Customs ",4,1,0.5,0.8,1.0,255,255,255,255)
								...
								drawTxt("~r~Fermé, veuillez patienter...",4,1,0.5,0.8,1.0,255,255,255,255)
							end
						end
					end
				end
...
function ButtonSelected(button)
	...
	elseif lsc.currentmenu == "main" then
		...
		elseif button.name == "Klaxons" then
			SetVehicleModKit(car,0)
			OpenMenu("horn")
		elseif button.name == "Lumières" then
			SetVehicleModKit(car,0)
			OpenMenu("lights")
			
		elseif button.name == "Intérieur" then
			SetVehicleModKit(car,0)
			OpenMenu("rollcage")
		elseif button.name == "Toit" then
			SetVehicleModKit(car,0)
			OpenMenu("roof")
		elseif button.name == "Jupes" then
			SetVehicleModKit(car,0)
			OpenMenu("skirts")
	...
	elseif lsc.currentmenu == "primarycolor" then
		...
		elseif button.name == "Métal" then
			OpenMenu("primarymetal") 
		elseif button.name == "Métalique" then
	...
	elseif lsc.currentmenu == "bumpers" then
		if button.name == "Pare-chocs avants" then
			OpenMenu("frontbumper")
		elseif button.name == "Pare-chocs arrières" then
			OpenMenu("rearbumper")
		end
	elseif lsc.currentmenu == "lights" then
		if button.name == "Phares" then
			SetVehicleModKit(car,0)
			OpenMenu('headlights')
		elseif button.name == "Kits Néons" then
			OpenMenu('neonkits')
		end 
	elseif lsc.currentmenu == "neonkits" then
		if button.name == "Format néons" then
			OpenMenu('neonlayout')
		elseif button.name == "Couleurs néons" then
			OpenMenu('neoncolor')
		end 
	...
	elseif lsc.currentmenu == "wheels" then
		if button.name == "Type de jantes" then
			OpenMenu('wheeltype')
		elseif button.name == "Couleur des jantes" then
			OpenMenu('wheelcolor')
		elseif button.name == "Accessoires pour roues" then
			SetVehicleModKit(car,0)
